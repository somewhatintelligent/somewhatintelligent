...
const TextField = lazyField(() =>
  import("platform.ui/components/form/text-field").then((m) => ({ default: m.TextField })),
);
const TextareaField = lazyField(() =>
  import("platform.ui/components/form/textarea-field").then((m) => ({
    default: m.TextareaField,
  })),
);
const SelectField = lazyField(() =>
  import("platform.ui/components/form/select-field").then((m) => ({ default: m.SelectField })),
);
const CheckboxField = lazyField(() =>
  import("platform.ui/components/form/checkbox-field").then((m) => ({
    default: m.CheckboxField,
  })),
);
const CheckboxGroupField = lazyField(() =>
  import("platform.ui/components/form/checkbox-group-field").then((m) => ({
    default: m.CheckboxGroupField,
  })),
);
const RadioField = lazyField(() =>
  import("platform.ui/components/form/radio-field").then((m) => ({ default: m.RadioField })),
);
const SwitchField = lazyField(() =>
  import("platform.ui/components/form/switch-field").then((m) => ({ default: m.SwitchField })),
);
const SliderField = lazyField(() =>
  import("platform.ui/components/form/slider-field").then((m) => ({ default: m.SliderField })),
);
const PasswordField = lazyField(() =>
  import("platform.ui/components/form/password-field").then((m) => ({
    default: m.PasswordField,
  })),
);
const EmailField = lazyField(() =>
  import("platform.ui/components/form/email-field").then((m) => ({ default: m.EmailField })),
);
const InputGroupField = lazyField(() =>
  import("platform.ui/components/form/input-group-field").then((m) => ({
    default: m.InputGroupField,
  })),
);
const SubmitButton = lazyField(() =>
  import("platform.ui/components/form/submit-button").then((m) => ({ default: m.SubmitButton })),
);
const ResetButton = lazyField(() =>
  import("platform.ui/components/form/reset-button").then((m) => ({ default: m.ResetButton })),
);
